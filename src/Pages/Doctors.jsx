...
const Doctors = () => {
    ...
    <section>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-6'>
            {Doctors2.map((item) => (
            <div key={item.id} className="bg-[#F5F5F5] md:w-72 xl:w-96 p-2 h-auto overflow-hidden flex flex-col hover:bg-[#FFF1D4] transition-all duration-300 cursor-pointer">
                <img 
                    src={item.Image} 
                    alt={item.name} 
